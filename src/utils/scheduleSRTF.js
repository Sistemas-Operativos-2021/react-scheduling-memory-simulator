  ...
  console.log(configuration)
    ...
    for (let clock = 0; clock < totalClock; clock++) {
      ...
      if (memory.some((partition) => !partition.isInUse)) {
        ...
        readySuspendState.push(...newState);
      }
      ...
      console.log(JSON.parse(JSON.stringify(readyState)))
